...
* **Confidence Threshold 슬라이드바 제공**: 사용자가 자신이 올린 동영상의 환경요인을 고려하여 유동적으로 Confidence Score를 조절
...
6. threshold 슬라이드바: 사용자 주도형 임계값 제어 모듈
...
### 코랩 실행 내역
**코랩 링크**: [https://colab.research.google.com/drive/1_lM9oKNGGOP-E2lwEe_spBOlKXM0d26s?usp=sharing]